...
def angle_3d_points(point1, point2):
    "cos(theta) = a.b/|a||b|"

    ab = (point1[0] * point2[0]) + (point1[1] * point2[1]) + (point1[2] * point2[2])
    mod_a = math.sqrt(point1[0] ** 2 + point1[1] ** 2 + point1[2] ** 2)
    mod_b = math.sqrt(point2[0] ** 2 + point2[1] ** 2 + point2[2] ** 2)
    angle = math.acos(ab / (mod_a * mod_b))
    return angle
